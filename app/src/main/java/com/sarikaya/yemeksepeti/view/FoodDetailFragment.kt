...
class FoodDetailFragment : Fragment() {
    ...
    private lateinit var resImg: String
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addBasket.setOnClickListener {
            val action = FoodDetailFragmentDirections.actionFoodDetailFragmentToBasketFragment(args.id,binding.foodDetailName.text.toString(),count.toString(),
                (count*price).toString(),binding.foodNote.text.toString(),resImg,foodImg)
            ...
            .addOnSuccessListener { food->
                for(doc in food){
                    if(args.title == doc.data["title"].toString()){
                        ...
                        foodImg = doc.data["pic"].toString()
                        resImg = doc.data["resId"].toString()
                    }
                }
            }
    }
